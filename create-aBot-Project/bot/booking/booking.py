...
class Booking(webdriver.Chrome):
    def __init__(self, driver_path = r"/Users/kaylanguyen/SeleniumDrivers", teardown = False):
    ...
    def select_adults(self, count=1):
        selection_elenment = self.find_element_by_id('xp__guests__toggle')
        selection_elenment.click()
        ...
        while True:
            ...
            adults_value_elenment = self.find_element_by_id('group_adults')
            adults_value = adults_value_elenment.get_attribute(
                'value'
